...
| **`denoising_indices`**       | Specifies which video shall be denoised with a Gaussian filter within each population. The standard deviation shall be inputted as an unsigned 8-bit integer.                                                                                       | Example: `Population_1: 0:15` (denoise the first video of Population_1 with a standard deviation of 15)                                             |
